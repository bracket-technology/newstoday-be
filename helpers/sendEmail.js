                            ...
                            <td class="r2-c" align="center">
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r3-o"
                                ...
                                <tr class="nl2go-responsive-hide">
                                  <td height="20" style="font-size: 20px; line-height: 20px; background-color: #ffffff;">
                                    ­</td>
                                </tr>
                                <tr>
                                              ...
                                              <td valign="top" class="r7-i">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                  ...
                                                  <tr>
                                                    <td class="r12-c" align="left">
                                                      <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                                        width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                        <tr class="nl2go-responsive-hide">
                                                  ...
                                                  <tr>
                                                    <td class="r2-c" align="center">
                                                      <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                                        width="290" class="r16-o" style="table-layout: fixed; width: 290px;">
                                                        <tr class="nl2go-responsive-hide">
                                                          <td height="15" style="font-size: 15px; line-height: 15px;">
                                                            ­</td>
                                                        </tr>
                                                        <tr>
                                                          <td height="18" align="center" valign="top"
                                                            ...
                                                            <a class="r18-r default-button" href="${url}" target="_blank"
                                                              data-btn="1"
                                                              style="font-style: normal; font-weight: normal; line-height: 1.15; text-decoration: none; border-style: solid; display: inline-block; -webkit-text-size-adjust: none; mso-hide: all; background-color: #000000; border-color: #000000; border-radius: 4px; border-width: 0px; color: #ffffff; font-family: arial,helvetica,sans-serif; font-size: 16px; height: 18px; padding-bottom: 12px; padding-left: 5px; padding-right: 5px; padding-top: 12px; width: 280px;">
                                                              <p style="margin: 0;">
                                                                Verify
                                                                Account</p>
                                                            </a>
                                              ...
                                              <td valign="top" class="r7-i">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                  ...
                                                  <tr>
                                                    <td class="r19-c">
                                                      <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                                        width="570" class="r6-o" style="table-layout: fixed; width: 570px;">
                                                        <!-- -->
                                                        <tr>
                                                          <td valign="top" class="">
                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                              ...
                                                              <tr>
                                                                <td class="r20-c" align="center" style="display: inline-block;">
                                                                  <table cellspacing="0" cellpadding="0" border="0"
                                                                    role="presentation" width="570" class="r3-o"
                                                                    style="table-layout: fixed; width: 570px;">
                                                                    <!-- -->
                                                                    <tr class="nl2go-responsive-hide">
                                                                      <td height="15" width="245"
                                                                    ...
                                                                    <tr>
                                                                      <td class="nl2go-responsive-hide" width="245"
                                                                        style="font-size: 0px; line-height: 1px;">
                                                                        ­
                                                                      </td>
                                                                      <td class="r21-i">
                          ...
                          <tr>
                            <td class="r2-c" align="center">
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r3-o"
                                ...
                                <!-- -->
                                <tr class="nl2go-responsive-hide">
                                  <td height="20" style="font-size: 20px; line-height: 20px; background-color: #eff2f7;">
                                    ­</td>
                                </tr>
                                <tr>
                                                          ...
                                                          <td align="center" valign="top" class="r27-i nl2go-default-textstyle"
                                                            ...
                                                            <div>
                                                              <p style="margin: 0; font-size: 14px;">
                                                                Street gorongan 5 no 172 wahid hasyim, 55283, Sleman</p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                      </table>
                                                      ...
                                                      <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                                        ...
                                                        <tr>
                                                          <td align="center" valign="top" class="r27-i nl2go-default-textstyle"
                                                            ...
                                                            <div>
                                                              <p style="margin: 0; font-size: 14px;">
                                                                You've received this email because you've register to our website.
                                                              </p>
                                                            </div>
                                                          </td>
                                                        </tr>
